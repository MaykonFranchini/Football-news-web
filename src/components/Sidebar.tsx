      ...
      {!club &&
        <div>
          ...
          <div className={styles.clubsList}>
            <nav>
              <a href="#" className={selectedLocation === 'serie-a'? styles.active : ''} data-location='serie-a' onClick={handleSelectLocation}>Serie A</a>
              <a href="#" className={selectedLocation === 'serie-b' ? styles.active : ''} data-location='serie-b' onClick={handleSelectLocation}>Serie B</a>
              <a href="#" className={selectedLocation === 'europa' ? styles.active : ''} data-location='europa' onClick={handleSelectLocation}>Europa</a>
            </nav>
